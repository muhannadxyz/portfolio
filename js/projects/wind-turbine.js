...
window.WindTurbineProject = {
  ...
  overview: 'An advanced IoT monitoring system for wind turbines using C and Arduino. Features include Hall-effect sensors for RPM measurement, voltage/current sensors for power analysis, RTC integration for timestamping, and comprehensive data logging with anomaly detection.',
  location: 'Remote',
  date: '2025-05-01',
