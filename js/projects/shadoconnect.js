...
window.ShadoconnectProject = {
  ...
  overview: 'ShadoConnect is a healthcare career development platform that connects students with healthcare professionals for shadowing opportunities, internships, and mentorship. Features include AI-powered matching, real-time scheduling with calendar integration, comprehensive messaging, and application tracking.',
  location: 'Remote',
  date: '2025-07-15',
